...
var getPotentiallyOpenIssues = function(callback) {
    ...
    var easy = $.ajax({
        dataType: "json",
        url: issuesUrl,
        data: "q=created:" + olderThanTwoWeeks + "+state:open+label:C-assigned+label:E-Easy+repo:rust-lang/rust&sort=created"
    });

    var lessEasy = $.ajax({
        dataType: "json",
        url: issuesUrl,
        data: "q=created:" + olderThanTwoWeeks + "+state:open+label:C-assigned+label:\"E-Less%20easy\"+repo:rust-lang/rust&sort=created"
    });
...
var getOpenIssues = function(callback) {
    ...
    var easy = $.ajax({
        dataType: "json",
        url: issuesUrl,
        data: "q=state:open+-label:C-assigned+label:E-Easy+repo:rust-lang/rust&sort=created"
    });

    var lessEasy = $.ajax({
        dataType: "json",
        url: issuesUrl,
        data: "q=state:open+-label:C-assigned+label:\"E-Less%20easy\"+repo:rust-lang/rust&sort=created"
    });
